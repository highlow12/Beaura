...
describe("compiled Markdown boundary", () => {
  it("renders Korean headings, escaped code, and Python highlighting at build time", () => {
  ...
  it("preserves local images and labels external links", () => {
    const html = compileMarkdown(
      "![배열](/generated/assets/array.png)\n\n[설명](https://example.com)",
    );
    expect(html).toContain('src="/generated/assets/array.png"');
